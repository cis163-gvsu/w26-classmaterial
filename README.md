...
* Go from being able to write code to being able to write *good* code
* Develop critical thinking skills
* Understand and employ logical reasoning and algorithmic thinking
* Learn the basics of Object-Oriented Programming
* Think about how efficient your approach is

### Helpful Links

* [Syllabus](syllabus.md)
* [PrairieLearn](https://us.prairielearn.com/pl/course_instance/205642) - log-in
  using "Google" and use your GVSU gmail account
* [Computing Success Center Calendar](https://www.gvsu.edu/computing/student-success-center-103)
  * Opens for drop-in tutoring in thesecond week of class
